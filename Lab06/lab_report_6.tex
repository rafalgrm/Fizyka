...
\begin{tabular}[c]{@{}l@{}}Data wykonania:\\ \\ \\ 25.11.2014\end{tabular}                     & \begin{tabular}[c]{@{}l@{}}Data oddania:\\ \\ \\ 2.12.2014\end{tabular} & \begin{tabular}[c]{@{}l@{}}Zwrot do poprawy:\\ \\ \\ 16.12.2014\end{tabular} & \begin{tabular}[c]{@{}l@{}}Data oddania:\\ \\ \\ 13.01.2015\end{tabular} & \begin{tabular}[c]{@{}l@{}}Data zaliczenia:\\ \\ \\ .\end{tabular} & OCENA:                                                  \\ \bottomrule
\end{tabular}
\end{table}
...
\textbf{1 minimum} & -7.40 & 6.40 & 6.90 & $(9.19 \pm 0.5) \cdot 10^{-5} $ \\ \hline
\textbf{1 maksimum boczne} & -9.80 & 9.20 & 9.50 & $(1.0 \pm 0.05) \cdot 10^{-4}$ \\ \hline
\textbf{2 minimum} & -14.40 & 13.20 & 13.80 & $(9.19 \pm 0.5) \cdot 10^{-5}$ \\ \hline
\textbf{2 maksimum boczne} & -15.40 & 15.20 & 15.30 & $(1.04 \pm 0.05) \cdot 10^{-4}$ \\ \hline
\end{tabular}}
...
\textbf{2 maksimum boczne} & 0 & 0 & 0.000\protect\footnotemark & 0.016 \\ \hline
\end{tabular}
\caption{Natężenie światła dla maksimów w jednostkach umownych dla szczeliny pojedynczej}
\label{}
\end{table}
\footnotetext{Wyniki w tabelach podane są przed znormalizowaniem, które było potrzebne do narysowania wykresu zlogarytmowanego. W niektórych pomiarach otrzymywaliśmy natężenie (umowne) ujemne. Stąd pojawia się w opracowaniu wartość natężenia 0, nie jest to jednak wartość najmniejsza.}
